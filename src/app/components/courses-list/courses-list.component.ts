...
export class CoursesListComponent implements OnInit {
    ...
    userRating: number = 0;
    userComment: string = '';
    selectedCategory: string = 'all'; //  ✅  selectedCategory initialized to 'all'
    hoveredRating = 0;
    ...
    filterCourses(): void {
      if (this.selectedCategory === 'all') {
        this.filteredCourses = [...this.courses]; // Copy all courses to filteredCourses
      } else {
    ...
    onCategoryButtonClick(category: string): void {
      ...
      this.filterCourses(); // Re-filter courses when category changes
    }
    ...
    selectCategory(category: string): void { //  ✅ selectCategory method
        this.selectedCategory = category;
        // Here you would typically trigger a data reload or filtering
        // For now, basic implementation in template button click
